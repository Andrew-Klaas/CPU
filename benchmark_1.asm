...
;  shows dirty/clean evictions L2 -> show any victim writes
;  shows multiple consecutive cache misses, initial LDI's
;  shows LRU policy on L2 -> eviction. take a look at 9672
;
;  VICTIM
;  shows  evictions VICTIM
;	-> also multiple consecutive dirty evictions -> take a look at when pmem_write is high, pmem_resp
;  shows LRU policy on victim cache
